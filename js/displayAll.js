function displayAll() {
  ...
  this.listLentern_1 = document.querySelectorAll(
    ".contain-tree-flower:nth-child(1) > .lentern"
  ); // Các lồng đèn trên cây đào
  this.listLentern_2 = document.querySelectorAll(
    ".contain-tree-flower:nth-child(2) > .lentern"
  ); // Các lồng đèn trên cây mai
  ...
  this.displayLentern = function () {
    ...
    var interval_1 = setInterval(() => {
      ...
      ++i;
      if (i == 3) clearInterval(interval_1);
    }, 1500);
    ...
    var interval_2 = setInterval(() => {
      ...
      ++j;
      if (j == 3) clearInterval(interval_2);
    }, 1500);
